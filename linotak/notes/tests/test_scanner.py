    ...
    def test_a_with_text(self):
        ...
        self.assertEqual(
            ...
            [
                Link(
                    None,
                    "https://example.com/User:Jeena.net",
                    title="User:Jeena.net",
                    text="Jeena Paradies",
                ),
            ],
        )
        ...
        self.assertEqual(
            ...
            [
                Link(
                    ...
                    classes=["u-url", "url", "u-uid", "uid", "bookmark"],
                )
            ],
        )
...
class TestPropertyCapture(ScanMixin, TestCase):
    ...
    def test_simple_abbr_property(self):
        stuff = self.scan(
            '<abbr class="p-name" title="Longer Value">Short Value</abbr>'
        )
        self.assertEqual(
            stuff, [Property("p-name", "Longer Value", original="Short Value")]
        )

    def test_uses_alt_attr_of_img(self):
        stuff = self.scan(
            '<img src="/img/1.jpeg" alt="Alice de Winter" class="p-name">'
        )
        self.assertEqual(
            stuff,
            [
                Property("p-name", "Alice de Winter"),
                Img("https://example.com/img/1.jpeg", classes=["p-name"]),
            ],
        )
            ...
            [
                HSomething(
                    ...
                    [
                        ...
                        Link(
                            None,
                            "http://indiewebcamp.com/2013",
                            text="IndieWebCamp 2013",
...
class TestHCardMixin(ScanMixin, TestCase):
    ...
    def test_unabbreviates_abbrev(self):
        ...
        self.assertIn(
            HCard("Tantek Çelik", short_name="Çelik", classes=["p-author"]), stuff
        )
            ...
            [
                HCard(
                    ...
                    Link(
                        ...
                        title="Tantek Çelik",
                        text="Tantek Çelik",
                        classes=["p-author", "h-card", "author-icon"],
                    ),
                    Img("https://example.com/logo.jpg"),
                    ["p-author", "author-icon"],
                ),
            ],
        )
...
class TestHCiteMixin(ScanMixin, TestCase):
    ...
    def test_citation_with_date_and_archived_version(self):
        ...
        self.assertIn(
            Link(
                None,
                "https://seblog.nl/2018/05/09/5/de-magie-van-webmentions",
                ...
                author=HCard(
                    ...
                    Link(
                        None,
                        "https://example.com/User:Seblog.nl",
                        title="User:Seblog.nl",
    ...
    def test_resolves_image_URL(self):
        ...
        self.assertIn(
            HEntry(
                ...
                images=[
                    Img(
                        "https://example.com/_next/static/images/bike-geometry-preview-6a639ba8720feb24c9d18ad77bf7ed2e.png"
                    ),
                ],
            ),
            stuff,
