...
class TestDocument(TestCase):
    ...
    def test_can_write_empty_feed(self):
        doc = Document('atom:feed', prefix_namespaces={'atom': 'http://www.w3.org/2005/Atom'})
    ...
    def test_can_xml_lang_attributes(self):
        doc = Document('atom:feed', {'xml:lang': 'en-GB'}, prefix_namespaces={'atom': 'http://www.w3.org/2005/Atom'})
    ...
    def test_can_use_default_namespace(self):
        doc = Document('feed', {'xml:lang': 'en-GB'}, prefix_namespaces={'': 'http://www.w3.org/2005/Atom'})
